...
class FoxholeMonitorUI:
    def __init__(self, root):
        ...
        self.strategy_label = ttk.Label(root, text="Strategies:", font=("Arial", 14, "bold"))
        self.strategy_label.pack(padx=20, pady=(10, 0))
        self.run_circle_active = False
        self.run_circle_btn = ttk.Button(root, text="Run in Circle", command=self.toggle_run_in_circle)
